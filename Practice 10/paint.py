...
def draw_ui(screen, tool, color_mode, radius):
    ...
    pygame.draw.rect(screen, (30, 30, 30), pygame.Rect(8, 8, 285, 125))
    pygame.draw.rect(screen, (90, 90, 90), pygame.Rect(8, 8, 285, 125), 2)
    ...
    hints = [
        "P brush  E eraser  O circle  T rectangle",
